...
ageFast="les chatons sont trop mignons pour moi"
userInput=input("pour accèder à ce site, tappez tout ce que vous voulez sauf la phrase: " + ageFast)
if(ageFast==userInput):
